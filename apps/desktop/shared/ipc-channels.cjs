...
const IPC_CHANNELS = Object.freeze({
  ...
  'academy:models:cancelDownload': null,
  ...
  'academy:chat:cancelLoad': null,
  'academy:chat:preload': null,
  ...
  'academy:playground-credentials:list': null,
  ...
  'academy:speech-to-text': 'academySpeechToTextSchema',
  'academy:voice:start': 'academyVoiceStartSchema',
  'academy:voice:stop': 'chatRequestIdSchema',
  'academy:voice:startConversation': 'academyVoiceStartConversationSchema',
  'academy:voice:stopConversation': 'chatRequestIdSchema',
