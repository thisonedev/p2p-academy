  ...
  },
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        slug: 'llamacpp-tools-auto-dialect',
        href: lessonHref('text-generation', 'llamacpp-tools-auto-dialect'),
      },
    ],
  },
  {
  ...
  },
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        slug: 'parakeet-microphone-record',
        href: lessonHref('transcription', 'parakeet-microphone-record'),
      },
      {
        num: '09',
        title: 'Stream microphone transcripts with Parakeet EOU',
        slug: 'parakeet-microphone-stream',
        href: lessonHref('transcription', 'parakeet-microphone-stream'),
      },
      {
        num: '10',
        title: 'Stream speaker-attributed transcripts with Sortformer v2.1',
        slug: 'parakeet-sortformer-streaming',
        href: lessonHref('transcription', 'parakeet-sortformer-streaming'),
      },
      {
        num: '11',
        title: 'Transcribe long audio files in silence-aware chunks',
        slug: 'parakeet-tdt-filesystem-chunked',
        href: lessonHref('transcription', 'parakeet-tdt-filesystem-chunked'),
      },
      {
        num: '12',
